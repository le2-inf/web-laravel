...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Rental\Vehicle\RentalVehicleMaintenance>
 */
class RentalVehicleMaintenanceFactory extends Factory
{
    /**
