...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Rental\Vehicle\RentalVehiclePreparation>
 */
class RentalVehiclePreparationFactory extends Factory
{
    /**
