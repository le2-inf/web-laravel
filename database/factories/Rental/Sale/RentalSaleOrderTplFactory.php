...
/**
 * @extends Factory<RentalSaleOrderTpl>
 */
class RentalSaleOrderTplFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'rental_payment_type'   => ($rental_payment_type = SoRentalType::LONG_TERM == $so_type ? SoRentalPaymentType::label_key_random() : null),
