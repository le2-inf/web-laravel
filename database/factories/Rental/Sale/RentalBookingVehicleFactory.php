...
/**
 * @extends Factory<RentalBookingVehicle>
 */
class RentalBookingVehicleFactory extends Factory
{
    protected $model = RentalBookingVehicle::class;
    ...
    {
        return $this->state(function () use ($rentalVehicle) {
            return ['plate_no' => $rentalVehicle->plate_no];
        });
    }
}
