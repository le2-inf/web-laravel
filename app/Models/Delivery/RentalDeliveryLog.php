 ...
 *
 *  -- relations
 * @property RentalDeliveryChannel $RentalDeliveryChannel
 */
class RentalDeliveryLog extends Model
{
    use ModelTrait;
    ...
    public function RentalDeliveryChannel(): BelongsTo
    {
        return $this->belongsTo(RentalDeliveryChannel::class, 'dc_key', 'dc_key');
    }
