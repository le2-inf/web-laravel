 ...
 */
class RentalVehicleManualViolation extends Model
{
    use ModelTrait;
    ...
    public static function indexQuery(array $search = []): Builder
    {
        ...
        return DB::query()
            ->from('rental_vehicle_manual_violations', 'vmv')
            ->leftJoin('rental_vehicles as ve', 've.ve_id', '=', 'vmv.ve_id')
            ->leftJoin('rental_vehicle_usages as vu', 'vu.vu_id', '=', 'vmv.vu_id')
    ...
    {
        return [
            'plate_no'           => [RentalVehicleManualViolation::class, 'plate_no'],
            'violation_datetime' => [RentalVehicleManualViolation::class, 'violation_datetime'],
            'location'           => [RentalVehicleManualViolation::class, 'location'],
            'violation_content'  => [RentalVehicleManualViolation::class, 'violation_content'],
            'fine_amount'        => [RentalVehicleManualViolation::class, 'fine_amount'],
            'penalty_points'     => [RentalVehicleManualViolation::class, 'penalty_points'],
            'status'             => [RentalVehicleManualViolation::class, 'status'],
            'vmv_remark'         => [RentalVehicleManualViolation::class, 'vmv_remark'],
        ];
    }
