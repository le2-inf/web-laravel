 ...
 * @property RentalVehicleInspection $RentalVehicleInspection
 ...
 */
class RentalVehicleRepair extends Model
{
    use ModelTrait;
    ...
    public function RentalPayment(): HasOne
    {
        ...
        return $this->hasOne(RentalPayment::class, 'vr_id', 'vr_id')
    ...
    public static function indexQuery(array $search = []): Builder
    {
        ...
        return DB::query()
            ->from('rental_vehicle_repairs', 'vr')
            ->leftJoin('rental_service_centers as sc', 'sc.sc_id', '=', 'vr.sc_id')
            ->leftJoin('rental_vehicles as ve', 've.ve_id', '=', 'vr.ve_id')
    ...
    {
        return [
            'plate_no'           => [RentalVehicleRepair::class, 'plate_no'],
            'entry_datetime'     => [RentalVehicleRepair::class, 'entry_datetime'],
            'vr_mileage'         => [RentalVehicleRepair::class, 'vr_mileage'],
            'repair_cost'        => [RentalVehicleRepair::class, 'repair_cost'],
            'delay_days'         => [RentalVehicleRepair::class, 'delay_days'],
            'sc_name'            => [RentalServiceCenter::class, 'sc_name'],
            'repair_content'     => [RentalVehicleRepair::class, 'repair_content'],
            'departure_datetime' => [RentalVehicleRepair::class, 'departure_datetime'],
            'repair_status'      => [RentalVehicleRepair::class, 'repair_status'],
            'settlement_status'  => [RentalVehicleRepair::class, 'settlement_status'],
            'pickup_status'      => [RentalVehicleRepair::class, 'pickup_status'],
            'settlement_method'  => [RentalVehicleRepair::class, 'settlement_method'],
            'custody_vehicle'    => [RentalVehicleRepair::class, 'custody_vehicle'],
            'repair_attribute'   => [RentalVehicleRepair::class, 'repair_attribute'],
            'vr_remark'          => [RentalVehicleRepair::class, 'vr_remark'],
        ];
    }
