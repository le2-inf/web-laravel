 ...
 */
class RentalVehicleForceTake extends Model
{
    use ModelTrait;
    ...
    public static function indexQuery(array $search = []): Builder
    {
        ...
        return DB::query()
            ->from('rental_vehicle_force_takes', 'vft')
            ->leftJoin('rental_vehicles as ve', 've.ve_id', '=', 'vft.ve_id')
            ->leftJoin('rental_vehicle_models as vm', 'vm.vm_id', '=', 've.vm_id')
            ->leftJoin('rental_customers as cu', 'cu.cu_id', '=', 'vft.cu_id')
