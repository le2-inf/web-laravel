...
class RentalInoutController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $query   = RentalPaymentInout::indexQuery();
        $columns = RentalPaymentInout::indexColumns();
    ...
    {
        $this->response()->withExtras(
            $with_group_count ? IoIoType::options_with_count(RentalPaymentInout::class) : IoIoType::options(),
        );
    }
}
