...
#[AsCommand(
    name: '_dev:rental-payment-type:import',
    description: ''
)]
class RentalPaymentTypeImport extends Command
{
    protected $signature   = '_dev:rental-payment-type:import';
    protected $description = '';

    public function handle(): int
    {
        $this->info('开始更新 rental-payment-type...');

        DB::transaction(function () {
            $query = RentalPaymentType::query();
        ...
        $this->info('更新 rental-payment-type 完毕。');
