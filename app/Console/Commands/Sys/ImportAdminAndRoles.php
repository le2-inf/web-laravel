...
class ImportAdminAndRoles extends Command
{
    ...
    private array $builtinRoles = [
        ...
        self::role_payment => [InoutController::class, PaymentAccountController::class, PaymentController::class, PaymentTypeController::class, SaleOrderRentPaymentController::class, SaleOrderSignPaymentController::class, VehiclePreparationController::class],
        ...
        self::role_manager => [Configuration0Controller::class, DocTplController::class, CustomerController::class, InoutController::class, PaymentController::class, PaymentAccountController::class, PaymentTypeController::class, StaffController::class, StaffPermissionController::class, StaffRoleController::class, OneAccountController::class, VehicleController::class, ServiceCenterController::class, SaleOrderController::class, CustomerController::class, DeliveryWecomGroupController::class, DeliveryWecomMemberController::class, DocTplController::class],
        self::role_system  => [Configuration0Controller::class, Configuration1Controller::class, ImportController::class, StaffController::class, StaffPermissionController::class, StaffRoleController::class, DeliveryChannelController::class, DeliveryLogController::class],
    ];
