...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route( sprintf('config%d.edit_confirm',$uc),array('configuration'=>$configuration['cfg_key'])) }}">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                @lang('app.methods.edit'){{ $uc_label }}@lang('class.cb_configurations')
                            </h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-xl-4 input-group">
                                    <input class="form-control" value="{{old('cfg_key',$configuration['cfg_key'])}}" name="cfg_key"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-xl-4 input-group">
                                    <input class="form-control" name="cfg_value" @if ($configuration['masked']==\App\Enum\Config\CfgMasked::LABELS) type="password" @endif value="{{old('cfg_value',$configuration['cfg_value'])}}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-xl-4 input-group">
                                    ...
                                    <span class="col-form-label">{{ $configuration['usage_category_label'] }}</span>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        @foreach(\App\Enum\Config\CfgMasked::LABELS as $key=>$label)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="masked" id="masked_{{ $key }}" value="{{ $key }}" @checked( old('masked',$configuration['masked']) === $key )>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-xl-4 input-group">
                                    <textarea name="description" class="form-control">{{ $configuration['description'] }}</textarea>
