                ...
                <form action="{{ route('admins.update',$admin->id) }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('class.admins')@lang('app.methods.edit')</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-xl-4 input-group">
                                    <select class="j a_select2" style="width: 100%;" multiple="multiple" name="roles[]" data-placeholder="@lang('app.methods.select_option_please')">
                                        @foreach($AdminRoleOptions as $role)
                                            <option value="{{ $role->value }}" {{ ($admin->hasRole($role->value) ? "selected":'') }}>{{ $role->text }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-xl-3 col-form-label">@lang('property.Admin.password')</label>
                                <div class="col-sm-8 col-xl-4 input-group">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-sm-4 col-xl-3 col-form-label ">@lang('property.Admin.password_confirmation')</label>
                                <div class="col-sm-8 col-xl-4 input-group">
